    ...
    <body>
        ...
        <form method = "post" action = "edit.php">
            ...
            <?php
                ...
                echo ('<div id = "educationContent">' . "\n");

                if (count($educations) > 0) {
                    foreach ($educations as $education) {
                        $edu ++;
    
                        echo ('<div id = "educationContent' . $edu . '">' . "\n");
                        echo ('<p> Year: <input type = "text" name = "edu_year' . $edu . '" value = "' . $education['year'] . '">' . "\n");
                        echo ('<input type = "button" value = "-" onclick = "$(\'#educationContent' . $edu . '\').remove(); return false;">' . "\n");
                        echo ("</p>\n");
            ...
            $(document).ready(function() {
                ...
                $(document).ready(function() {
                    ...
                    $('#addEdu').click(function(event) {
                        ...
                        $('#educationContent').append(
                            '<div id = "educationContent' + countEdu + '"> \
                            <p> Year: <input type = "text" name = "edu_year' + countEdu + '" value = ""> \
                            <input type = "button" value = "-" \
                                onclick = "$(\'#educationContent' + countEdu + '\').remove(); return false;"> </p> \
